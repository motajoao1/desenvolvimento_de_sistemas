 ...
 */
package com.mycompany.variosprogramas;
...
public class SOMA extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
    double valor1 = Double.parseDouble(jTextField1.getText().replace(",", "."));
    double valor2 = Double.parseDouble(jTextField2.getText().replace(",", "."));
...
// Esvazia os três campos de texto
    jTextField1.setText("");
    jTextField2.setText("");
    jTextField3.setText("");
